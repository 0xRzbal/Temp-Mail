// JoeMail Admin - Sidebar Template
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <div class="nav-group">
                ...
                <a class="nav-item ${activePage === 'dashboard' ? 'active' : ''}" data-page="dashboard" href="/admin/dashboard.html">
                    <i class="fas fa-chart-pie"></i><span>Dashboard</span>
                </a>
                <a class="nav-item ${activePage === 'emails' ? 'active' : ''}" data-page="emails" href="/admin/emails.html">
                    <i class="fas fa-envelope"></i><span>Emails</span>
                </a>
                <a class="nav-item ${activePage === 'domains' ? 'active' : ''}" data-page="domains" href="/admin/domains.html">
                    <i class="fas fa-globe"></i><span>Domains</span>
                </a>
            </div>
            <div class="nav-group">
                <div class="nav-label">System</div>
                <a class="nav-item ${activePage === 'webhooks' ? 'active' : ''}" data-page="webhooks" href="/admin/webhooks.html">
                    <i class="fas fa-link"></i><span>Webhooks</span>
                </a>
                <a class="nav-item ${activePage === 'stats' ? 'active' : ''}" data-page="stats" href="/admin/stats.html">
...
function renderHeader(title) {
    ...
    <header class="app-header">
        ...
        <div class="header-right">
            ...
            <button class="btn-ghost" onclick="window.open('/', '_blank')"><i class="fas fa-external-link-alt"></i> Frontend</button>
        </div>
    </header>`;
}
